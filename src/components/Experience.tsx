...
export default function Experience() {
  return (
    <div className="relative pl-8 sm:pl-10">
      {/* Vertical line */}
      <div className="from-cyan via-violet absolute top-2 left-0 h-full w-px bg-linear-to-b to-transparent" />
          ...
          <Reveal key={item.role + item.company} delay={i * 0.1}>
            <div className="relative">
              ...
              <span className="bg-bg absolute top-1.5 left-[-2.35rem] grid h-4 w-4 place-items-center rounded-full sm:left-[-2.85rem]">
                <span className="from-cyan to-violet h-2.5 w-2.5 rounded-full bg-linear-to-br shadow-[0_0_12px_2px_var(--color-violet)]" />
              </span>
